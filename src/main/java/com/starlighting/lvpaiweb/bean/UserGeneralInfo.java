...
public class UserGeneralInfo  extends BasePojo {
    ...
    @One(target=DicPlace.class, field="location", key="id")
    protected DicPlace dicPlace;

    @One(target=PhotographerExtra.class, field="id", key="userGeneralInfoId")
    protected PhotographerExtra photographerExtra;

//    @One(target=AgencyExtra.class, field="id", key="userGeneralInfoId")
//    protected AgencyExtra agencyExtra;

    @One(target=CustomerExtra.class, field="id", key="userGeneralInfoId")
    protected CustomerExtra customerExtra;
    ...
    public PhotographerExtra getPhotographerExtra() {
        return photographerExtra;
    }

    public void setPhotographerExtra(PhotographerExtra photographerExtra) {
        this.photographerExtra = photographerExtra;
    }

//    public AgencyExtra getAgencyExtra() {
//        return agencyExtra;
//    }
//
//    public void setAgencyExtra(AgencyExtra agencyExtra) {
//        this.agencyExtra = agencyExtra;
//    }
