        ...
        $(document).ready(function() {
            ...
            $("#userRegisterForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    // 提交数据
                    $.ajax({
                        url: ctx + "/web/server/photoer/user_register_submit",
                        type: "POST",
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <form class="form-horizontal" method="post" action="#" id="userRegisterForm">
                <div class="form-group">
                    <label for="userName"  class="col-sm-4 control-label">用户名</label>
                    <div class="col-sm-5">
                        <input type="text" name="userName" maxlength="25"
                               id="username" class="form-control {validate:{required:true,trimstr:true,stringCheck:true,messages:{required:'请输入用户名'}}}"
                               placeholder="可使用英文字符、数字、汉字，最长××字符，必填">
                    </div>
                </div>
                <div class="form-group">
                    <label for="email"  class="col-sm-4 control-label">电子邮箱</label>
                    <div class="col-sm-5">
                        <input type="email" name="email" maxlength="25" class="form-control {validate:{required:true,trimstr:true,email:true,messages:{required:'请输入邮箱'}}}"
                               id="Email" placeholder="请填写正确邮箱，进行验证，必填">
                    </div>
                </div>
                <div class="form-group">
                    <label for="Mobile" class="col-sm-4 control-label">移动电话</label>
                    <div class="col-sm-5">
                        <input type="text" name="mobile" maxlength="11" class="form-control" id="Mobile" placeholder="请填写正确手机号码，旅拍者服务专员会与您联系，必填">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="password" name="password"  id="password"
                               maxlength="20" class="form-control {validate:{required:true,trimstr:true,passwordVal:true,rangelength:[6,20],messages:{required:'请输入密码',rangelength:'密码长度应为6-20位'}}}"
                               placeholder="设置密码，最少6位，且至少同时包含字母和数字，必填">
                    </div>
                </div>
                <div class="form-group">
                    <label for="password2" class="col-sm-4 control-label">确认密码</label>
                    <div class="col-sm-5">
                        <input type="password" class="form-control {validate:{equalTo:'#password',messages:{equalTo:'输入的密码不一致'}}}" id="password2"
