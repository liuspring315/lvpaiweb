                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div class="col-xs-2 lvpaizhe-a-margin-bottom">
                                <a class="btn btn-block btn-info" href="${ctx}/photographer/goods/add" role="button">
                                    <span class="fa fa-camera"></span>&nbsp;&nbsp;发布新的服务
                                </a>
                            </div>
...
<!-- ./wrapper -->
<form action="${ctx}/photographer/goods/view" id="goods_view_form" method="post">
...
<script type="text/javascript">
    ...
    function loadGoods(pageNumber,pageSize){
        ...
        $.ajax({
            url : ctx + "/photographer/goods/query",
            data : postdata,
            dataType : "json",
            type : "POST",
            success : function(re) {
                ...
                for (var i=0;i<data.list.length;i++) {
                    ...
                    if(goods.orderStat != 2){
                        tmp =  tmp +  "<button class=\"btn btn-primary btn-xs\" type='button' onclick='javascript:updateGoods("
                                +goods.id+")'><span class=\"fa fa-edit\"></span><strong>&nbsp;&nbsp;修改<strong></button>&nbsp;&nbsp;"
